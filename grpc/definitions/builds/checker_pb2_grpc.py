...
class CheckerStub(object):
    ...
    def __init__(self, channel):
        ...
        self.Check = channel.unary_unary(
                ...
                response_deserializer=checker__pb2.CheckResponse.FromString,
                )
...
def add_CheckerServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'Check': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=checker__pb2.CheckResponse.SerializeToString,
            ),
    }
...
class Checker(object):
    ...
    def Check(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/checker.Checker/Check',
            checker__pb2.CheckRequest.SerializeToString,
            checker__pb2.CheckResponse.FromString,
